     ...
     const citiesData = [
       {
         ...
         facts: [
           ...
           "В Токио проходит множество культурных событий и фестивалей."
         ]
       },
       {
         name: "Осака",
       ...
       {
        name: "Киото",
        description: "Город на острове Хонсю, известный своими многочисленными классическими буддийскими храмами, а также садами, императорскими дворцами, синтоистскими святынями и традиционными деревянными домами.",
